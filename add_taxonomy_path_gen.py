...
if __name__ == '__main__':
    ...
    parser.add_argument('--concept_dir', type=str, 
                        default='/home/lidong1/qilongma/mmlu-master/concepts/concepts_OpenAI-GPT-4o-mini', 
                        help='Directory containing MMLU dataset concepts')
    parser.add_argument('--output_dir', type=str, 
                        default='/home/lidong1/qilongma/mmlu-master/concepts/concepts_OpenAI-GPT-4o-mini_taxo_path_gen', 

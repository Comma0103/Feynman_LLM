...
def main(args):
    ...
    if not os.path.exists(os.path.join(args.expl_dir, "expls_{}_2nd".format(args.expl_model_name), "test")):
        os.makedirs(os.path.join(args.expl_dir, "expls_{}_2nd".format(args.expl_model_name), "test"))
    ...
    for subject in subjects:
        ...
        test_expls_df.to_csv(
            os.path.join(
                args.expl_dir, "expls_{}_2nd".format(args.expl_model_name), "test", "{}_2nd_expls.csv".format(subject)
            ),
            index=None,
        )
        toc = time.time()
...
if __name__ == "__main__":
    ...
    args.exp_name = f"{args.model_name}_feynman_{args.expl_model_name}_question_concept_2nd"
    main(args)

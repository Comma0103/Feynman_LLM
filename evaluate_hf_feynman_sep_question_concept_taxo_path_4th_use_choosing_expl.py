...
def main(args):
    ...
    # explanations have been generated in expls_OpenAI-GPT-4o-mini_sep_taxo_path_gen_4th
    # oai_client = Openai(
    ...
    # if not os.path.exists(os.path.join(args.expl_dir, "expls_{}_sep_taxo_path_{}_{}_wo_choosing_4th_use_choosing_expl".format(args.expl_model_name, args.taxo_path_src, args.model_name), "test")):
    #     os.makedirs(os.path.join(args.expl_dir, "expls_{}_sep_taxo_path_{}_{}_wo_choosing_4th_use_choosing_expl".format(args.expl_model_name, args.taxo_path_src, args.model_name), "test"))
    ...
    for subject in subjects:
        ...
        test_expls_df = pd.read_csv(
            os.path.join(
                args.expl_dir,
                "expls_{}_sep_taxo_path_{}_4th".format(args.expl_model_name, args.taxo_path_src),
                "test",
        ...
        #     os.path.join(
        #         args.expl_dir, "expls_{}_sep_taxo_path_{}_{}_wo_choosing_4th_use_choosing_expl".format(args.expl_model_name, args.taxo_path_src, args.model_name), "test", "{}_4th_expls.csv".format(subject)
        #     ),
        #     index=None,
        # )
        toc = time.time()
...
if __name__ == "__main__":
    ...
    args.exp_name = f"{args.model_name}_feynman_{args.expl_model_name}_sep_question_concept_taxo_path_{args.taxo_path_src}_wo_choosing_4th_use_choosing_expl"
    main(args)

...
def main(args):
    ...
    # if not os.path.exists(os.path.join(args.expl_dir, "expls_{}_sep_taxo_path_{}_{}_wo_choosing_2nd_use_llama2-7b_expl".format(args.expl_model_name, args.taxo_path_src, args.model_name))):
    #     os.makedirs(os.path.join(args.expl_dir, "expls_{}_sep_taxo_path_{}_{}_wo_choosing_2nd_use_llama2-7b_expl".format(args.expl_model_name, args.taxo_path_src, args.model_name)))
    ...
    for level in difficulty_levels:
        ...
        with open(os.path.join(args.expl_dir, "expls_{}_sep_taxo_path_{}_Meta-Llama-2-7B_wo_choosing_2nd".format(args.expl_model_name, args.taxo_path_src), f'{level}-Test_2nd_expls.jsonl'), 'r', encoding='utf-8') as test_expl_f:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_path", "-m", type=str, default="/data/qilongma/public_models/Meta-Llama-3-8B")
